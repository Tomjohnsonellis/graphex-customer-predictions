...
st.write("Graphext does some of the grunt work for us, it tries to work out what's important")
st.image("instant.png")
st.write("However, humans are still needed to make sense out of this.")
